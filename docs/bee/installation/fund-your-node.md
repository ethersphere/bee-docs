...
xDAI is required to pay for gas fees on the Gnosis Chain. There are **_four categories of transactions_** that require xDAI for on-chain interactions:
...
_Note that while the gas costs today are roughly similar to the examples above, gas fees may change over time due to potential network congestion and a variety of other factors._
...
xBZZ is used to pay for storing and retrieving data on Swarm. It is required for **_three categories of transactions_**:
