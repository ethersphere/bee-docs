...
Preparing to unpack .../archives/bee_2.3.1_amd64.deb ...
Unpacking bee (2.3.1) ...
Setting up bee (2.3.1) ...
...
```bash
wget -q -O - https://raw.githubusercontent.com/ethersphere/bee/master/install.sh | TAG=v2.3.1 bash
```

#### curl

```bash
curl -s https://raw.githubusercontent.com/ethersphere/bee/master/install.sh | TAG=v2.3.1 bash
```
### Build from source 
