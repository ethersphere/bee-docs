...
![Swarm CLI Stamp Buy Command](/img/stamp-buy.gif)

## Uploading a File

![Swarm CLI Upload Command](/img/upload.gif)

## Creating an Identity

![Swarm CLI Identity Create Command](/img/identity-create.gif)

## Uploading to a Feed

![Swarm CLI Feed Upload Command](/img/feed-upload.gif)
