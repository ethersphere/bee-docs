...
- `curl http://localhost:1635/chequebook/address` your chequebook contract to see the gBZZ.
...
Your chequebook will show OUT gBZZ transactions when your peers cash cheques issued by you, but you don't pay any gas for those so they won't show up in your Ethereum address transaction list.
