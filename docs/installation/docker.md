...
```bash
wget -q https://raw.githubusercontent.com/ethersphere/bee/v1.4.0/packaging/docker/docker-compose.yml
```
...
```bash
wget -q https://raw.githubusercontent.com/ethersphere/bee/v1.4.0/packaging/docker/env -O .env
```
