...
```bash
wget https://github.com/ethersphere/bee/releases/download/v1.11.1/bee_1.11.1_armhf.deb
sudo dpkg -i bee_1.11.1_armhf.deb
```

##### ARM64

```bash
wget https://github.com/ethersphere/bee/releases/download/v1.11.1/bee_1.11.1_arm64.deb
sudo dpkg -i bee_1.11.1_arm64.deb
```
...
```bash
wget https://github.com/ethersphere/bee/releases/download/v1.11.1/bee_1.11.1_amd64.rpm
sudo rpm -i bee_1.11.1_amd64.rpm
```
...
```bash
wget https://github.com/ethersphere/bee/releases/download/v1.11.1/bee_1.11.1_armv7.rpm
sudo rpm -i bee_1.11.1_armv7.rpm
```

##### ARM64

```bash
wget https://github.com/ethersphere/bee/releases/download/v1.11.1/bee_1.11.1_arm64.rpm
sudo rpm -i bee_1.11.1_arm64.rpm
```
